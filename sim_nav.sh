...
cmds=(  #"ros2 launch sam_bot_description robot.launch.py"
	...
	#"ros2 run tf2_ros static_transform_publisher 0.0 0.0 0 0 0 0 map odom"
	"ros2 run tf2_ros static_transform_publisher 0.0 0.0 0 0 0 0 livox_frame livox_frame1"
	...
	"ros2 launch rm_navigation bringup_launch_sim.py"
	"ros2 run controller rm_controller"
	"ros2 run commander cmd_vel_multiplier"
