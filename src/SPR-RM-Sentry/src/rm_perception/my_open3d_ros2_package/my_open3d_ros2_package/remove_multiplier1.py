...
class RobotHandler(Node):
    def __init__(self):
        ...
        self.reach_polygon_publisher = self.create_publisher(Int16, '/reach_polygon', 10)
    ...
    def cmd_vel_callback(self, msg):
        ...
        if self.robot_position:
                ...
                # if id != 0:  # 如果 id 不为 0，表示机器人位于某个多边形内部
                #     # 如果到达，则发布消息
                #     msg = Int16()
                #     msg.data = 1
                #     self.get_logger().info("Reached inside polygon")
                #     self.reach_polygon_publisher.publish(msg)
                ...
                #     msg = Int16()
                #     msg.data = 2
                #     self.get_logger().info("not Reached inside polygon")
                #     self.reach_polygon_publisher.publish(msg)
