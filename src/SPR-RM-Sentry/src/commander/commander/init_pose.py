...
def publish_2d_pose_estimate(node):
    ...
    pose_estimate_msg.pose.pose.position.x = -2.0  # 替换为机器人的X坐标
    pose_estimate_msg.pose.pose.position.y = -0.5  # 替换为机器人的Y坐标
    pose_estimate_msg.pose.pose.orientation.w = 1.0  # 替换为机器人的朝向
