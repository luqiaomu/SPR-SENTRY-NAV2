...
# 读取PGM格式的代价地图                              map1734510828.pgm
costmap = cv2.imread('/home/spr/Sentry_ws/src/SPR-RM-Sentry/src/rm_map/pgm_to_pointcloud/pgm/map1735121303.pgm', cv2.IMREAD_GRAYSCALE)

with open('/home/spr/Sentry_ws/src/SPR-RM-Sentry/src/rm_map/pgm_to_pointcloud/pgm/map1735121303.yaml', 'r') as file:
    data = file.read()
...
print(point_cloud)
o3d.io.write_point_cloud("/home/spr/Sentry_ws/src/SPR-RM-Sentry/src/rm_map/pgm_to_pointcloud/pcd/write1.pcd", point_cloud)
